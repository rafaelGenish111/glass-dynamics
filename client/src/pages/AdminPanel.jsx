                    ...
                    <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 shadow-xl sticky top-4">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="text-xs text-slate-400 block mb-1">{t('user_role')}</label>
                                ...
                                <div>
                                    <label className="text-xs text-slate-400 block mb-1">{t('user_lang')}</label>
                                    <select className="w-full bg-slate-900 border border-slate-600 rounded-lg p-2.5 text-white text-sm"
                ...
                <div className="lg:col-span-2">
                    <div className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden shadow-lg">
                        <div className="p-5 border-b border-slate-800 bg-slate-800/50 flex justify-between items-center">
                            <h3 className="text-lg font-bold text-white">{t('user_team')} ({users.length})</h3>
                        </div>
                ...
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    <div className="bg-slate-900 w-full max-w-lg rounded-2xl border border-slate-700 shadow-2xl p-6">
                        <div className="flex justify-between items-center mb-6 border-b border-slate-800 pb-4">
                            <h3 className="text-xl font-bold text-white">{t('edit_user')} {editingUser.name}</h3>
                        ...
                        <form onSubmit={handleUpdate} className="space-y-4">
                            ...
                            <div className="bg-slate-950/50 p-4 rounded-xl border border-slate-700/50">
                                <label className="text-xs text-orange-400 block mb-1 font-bold">{t('reset_password')}</label>
                                <div className="relative">
                                    <input type={showEditPassword ? "text" : "password"}
                                        ...
                                        placeholder={t('leave_empty_password')}
                            ...
                            <div className="flex justify-end gap-3 pt-4">
                                <button type="button" onClick={() => setEditingUser(null)} className="px-4 py-2 text-slate-400 hover:text-white">{t('cancel')}</button>
